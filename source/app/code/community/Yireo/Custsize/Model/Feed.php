 ...
 * Feed Model
 */
class Yireo_Custsize_Model_Feed extends Mage_AdminNotification_Model_Feed
{
    /**
     * Return the feed URL
     */
    protected $customFeedUrl = 'https://www.yireo.com/extfeed?format=feed&platform=magento&extension=custsize';
